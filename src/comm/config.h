...
const int port = ns_runtime_cfg::GetEnvIntOrDefault("OJ_DB_PORT", std::stoi("3306"));
...
const int smtp_port = ns_runtime_cfg::GetEnvIntOrDefault("OJ_SMTP_PORT", std::stoi("465"));
...
const int admin_port = ns_runtime_cfg::GetEnvIntOrDefault("OJ_ADMIN_PORT", std::stoi("8090"));
